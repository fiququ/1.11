class VRButton {
    ...
    showEnterVR(button) {
        ...
        this.stylizeElement(button, true, 25, true); // Increase font size to 40px and use default padding
        ...
        function onSessionEnded() {
            ...
            button.style.fontWeight = 'bold'; // Ensure text remains bold
        ...
        button.onmouseenter = function () {
            ...
            button.style.fontFamily = 'Arial, sans-serif'; // Change font style on hover
            button.textContent = 'ENTER VR';
        };
        ...
        button.onmouseleave = function () {
            ...
            button.style.fontFamily = ''; // Reset font style
            button.innerHTML = '<i class="fas fa-vr-cardboard"></i>';
        };
